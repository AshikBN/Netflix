    ...
    <div className="featured">
        {type && (
            <div className="category">
                ...
                <select className="ganre" id="ganre">
        ...
        <div className="info">
            ...
            <span className="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo itaque, voluptatibus mollitia inventore corrupti perferendis at quod blanditiis vitae provident debitis odit, ipsa magni error. Amet consectetur ad sequi quasi?</span>
